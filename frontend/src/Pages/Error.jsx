...
const Error = () => {
  ...
  return (
    <div className='w-full h-screen bg-white justify-center items-center flex-col flex max-sm:mx-[rem] max-md:mx-auto max-sm:mt-[-8vh]'>
      ...
      <button className="w-[9rem] h-[3rem] bg-teal-600 rounded-[9px] text-white text-[22px] font-semibold font-['Lexend'] text-white mt-[1rem] max-sm:w-[9rem] h-[2.5rem] max-sm:text-[20px]" onClick={() => navigate(-1)}>GO BACK</button>
    </div>
  );
}
